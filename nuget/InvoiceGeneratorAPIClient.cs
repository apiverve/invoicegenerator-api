...
namespace APIVerve.API.InvoiceGenerator
{
    ...
    /// <summary>
    /// Client for the InvoiceGenerator API
    /// </summary>
...
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/invoicegenerator";
        ...
        {
            { "invoiceNumber", new ValidationRule { Type = "string", Required = true } },
            { "date", new ValidationRule { Type = "string", Required = false, Format = "date" } },
            { "from_name", new ValidationRule { Type = "string", Required = true } },
            { "from_street", new ValidationRule { Type = "string", Required = true } },
            { "from_city", new ValidationRule { Type = "string", Required = true } },
            { "from_state", new ValidationRule { Type = "string", Required = true, MaxLength = 2 } },
            { "from_zip", new ValidationRule { Type = "string", Required = true, MinLength = 5, MaxLength = 10 } },
            { "to_name", new ValidationRule { Type = "string", Required = true } },
            { "to_street", new ValidationRule { Type = "string", Required = true } },
            { "to_city", new ValidationRule { Type = "string", Required = true } },
            { "to_state", new ValidationRule { Type = "string", Required = true, MaxLength = 2 } },
            { "to_zip", new ValidationRule { Type = "string", Required = true, MinLength = 5, MaxLength = 10 } },
            { "job", new ValidationRule { Type = "string", Required = false } },
            { "paymentTerms", new ValidationRule { Type = "string", Required = false } },
            { "dueDate", new ValidationRule { Type = "string", Required = false, Format = "date" } },
            { "discount", new ValidationRule { Type = "number", Required = false, Min = 0 } },
            { "salesTax", new ValidationRule { Type = "number", Required = false, Min = 0, Max = 100 } },
            { "currency", new ValidationRule { Type = "string", Required = false } },
            { "items", new ValidationRule { Type = "array", Required = true } }
        };
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public InvoiceGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public InvoiceGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, InvoiceGeneratorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(InvoiceGeneratorQueryOptions options)
        {
        ...
        public ResponseObj Execute(InvoiceGeneratorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(InvoiceGeneratorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(InvoiceGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(InvoiceGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(InvoiceGeneratorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(InvoiceGeneratorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(InvoiceGeneratorQueryOptions options)
        {
